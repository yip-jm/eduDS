        ...
        self.templates = {
            ...
            "lesson_plan_outline": {
                ...
                "user": (
                    ...
                    "IMPORTANT: Your response should be only the Markdown content itself. Do NOT wrap your entire output in a markdown code block (i.e., do not start with ```markdown or end with ```)."
                )
            },
